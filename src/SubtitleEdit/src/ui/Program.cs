...
namespace Nikse.SubtitleEdit
{
    internal class Program
    {
        ...
        public static bool UseSmtcPlayer { get; set; }
        ...
        public static void Main(string[] args)
        {
            ...
            try
            {
                ...
                {
                    // Parse args early so UseSmtcPlayer is set before window creation
        ...
        private static void ParseStartupArgs(string[] args)
        {
            ...
            {
                var a = args[i];
                if (a.Equals("--smtc", StringComparison.OrdinalIgnoreCase))
                {
                    UseSmtcPlayer = true;
                }
